...
class WorkbenchMultiEditorModuleTest {
    ...
    fun twoEditorsForSameKey_SameModel() {
        ...
        controller.executeAction(WorkbenchAction.UpdateEditor(moduleState, controller.informationState.getRegisteredEditors<TestModel>(type)[1]))
    ...
    fun twoEditorsForSameKey_DifferentModel() {
        ...
        controller.executeAction(WorkbenchAction.UpdateEditor(moduleState1, controller.informationState.getRegisteredEditors<TestModel2>(type)[1]))
